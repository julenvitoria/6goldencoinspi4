...
if grep -q "ActualizarMenu.sh" /home/pi/RetroPie/retropiemenu/gamelist.xml ; then
...
if grep -q "UpdateUpgradeSystem.sh" /home/pi/RetroPie/retropiemenu/gamelist.xml ; then
...
if grep -q "ActualizarEmulators.sh" /home/pi/RetroPie/retropiemenu/gamelist.xml ; then
...
if grep -q "ConfigsRemaps.sh" /home/pi/RetroPie/retropiemenu/gamelist.xml ; then
...
if grep -q "restoresystems.sh" /home/pi/RetroPie/retropiemenu/gamelist.xml ; then
...
if grep -q "installgamelist.sh" /home/pi/RetroPie/retropiemenu/gamelist.xml ; then
...
if grep -q "gw.sh" /home/pi/RetroPie/retropiemenu/gamelist.xml ; then
...
if grep -q "vice.sh" /home/pi/RetroPie/retropiemenu/gamelist.xml ; then
...
if grep -q "fbneo.sh" /home/pi/RetroPie/retropiemenu/gamelist.xml ; then
...
if grep -q "scummvm.sh" /home/pi/RetroPie/retropiemenu/gamelist.xml ; then
...
if grep -q "retroarch.sh" /home/pi/RetroPie/retropiemenu/gamelist.xml ; then
...
if grep -q "emulationstation.sh" /home/pi/RetroPie/retropiemenu/gamelist.xml ; then
